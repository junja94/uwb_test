...
if __name__ == "__main__":
    ...
    r = ReadyToRange(pozyx, anchors[0]["id"], range_step_mm,
                     ranging_protocol, remote_id)

    r2 = ReadyToRange(pozyx, anchors[1]["id"], range_step_mm,
                     ranging_protocol, remote_id)

    r3 = ReadyToRange(pozyx, anchors[2]["id"], range_step_mm,
                      ranging_protocol, remote_id)
    r.setup()
    r2.setup()
    r3.setup()
