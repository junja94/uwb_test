...
if __name__ == "__main__":
    ...
    remote_id = 0x117a              # remote device network ID
    ...
    y = 550
    anchors = [
        DeviceCoordinates(0x114a, 1, Coordinates(0, 0, 0)),
        DeviceCoordinates(0x117a, 1, Coordinates(x, 0, 0)),
        DeviceCoordinates(0x1125, 1, Coordinates(x, y, 0)),
        DeviceCoordinates(0x1138, 1, Coordinates(0, y, 0))
    ]
